...
public enum GameMenuCommands implements Command {
    ...
    ShowFarmingAbility("\\s*show\\s+farming\\s+ability\\s*"),
    ShowForagingAbility("\\s*show\\s+foraging\\s+ability\\s*"),
    ShowMiningAbility("\\s*show\\s+mining\\s+ability\\s*"),
    ShowFishingAbility("\\s*show\\s+fishing\\s+ability\\s*"),
