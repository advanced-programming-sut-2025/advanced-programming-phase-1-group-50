...
public class Furnace extends ArtisanMachine {
    ...
    public Result canUse(Player player, String product) {
        ...
        else if (product.equals("Iridium_Bar") || product.equals("iridium_bar")) {
            for (Ingredient ingredient : player.getBackpack().getIngredientQuantity().keySet()) {
        ...
        else if (product.equals("Copper_Bar") || product.equals("copper_bar")) {
            for (Ingredient ingredient : player.getBackpack().getIngredientQuantity().keySet()) {
        ...
        else if (product.equals("Gold_Bar") || product.equals("gold_bar")) {
            for (Ingredient ingredient : player.getBackpack().getIngredientQuantity().keySet()) {
