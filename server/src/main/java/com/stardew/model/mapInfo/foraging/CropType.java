...
public enum CropType implements Ingredient {
    BlueJazz(Seeds.JazzSeeds,
        ...
        CropTextureID.blueJazzStages, TextureID.blueJazzTexture),
    Carrot(Seeds.CarrotSeeds,
        new ArrayList<>(Arrays.asList(1, 1, 1)),
        3, true, 0, 35, true, 75,
        new ArrayList<>(List.of(Season.Spring)), false,
        CropTextureID.carrotStages, TextureID.carrotTexture),
    Cauliflower(Seeds.CauliflowerSeeds,
        ...
        CropTextureID.cauliflowerStages, TextureID.cauliflowerTexture),
    ...
    Blueberry(Seeds.BlueberrySeeds,
        ...
        CropTextureID.blueberryStages, TextureID.blueberryTexture),
    ...
    AncientFruit(Seeds.AncientSeeds,
        ...
        CropTextureID.ancientFruitStages, TextureID.ancientFruitTexture),;
    ...
    private final TextureID[] levelsTextures;
    ...
    CropType(Seeds source, ArrayList<Integer> stages, int totalHarvestTime, boolean oneTime, int regrowthTime,
             ...
             TextureID[] levelsTextures, TextureID mainTexture) {
        this.source = source;
        this.stages = stages;
    ...
    public TextureID[] getLevelsTextures() {
    ...
    public TextureID getMainTexture(){
        return mainTexture;
    }
