...
public class AnimalStateToAnimationIDMapper {
    ...
    static {
        ...
        chickenStates.put(AnimalState.IS_PETTING, AnimationID.chicken_is_petting);
    }
    ...
    static {
        ...
        duckStates.put(AnimalState.IS_PETTING, AnimationID.duck_is_petting);
    }
    ...
    static {
        ...
        rabbitStates.put(AnimalState.IS_PETTING, AnimationID.rabbit_is_petting);
    }
    ...
    static {
        ...
        dinosaurStates.put(AnimalState.IS_PETTING, AnimationID.dinosaur_is_petting);
    }
    ...
    static {
        ...
        cowStates.put(AnimalState.IS_PETTING, AnimationID.cow_is_petting);
    }
    ...
    static {
        ...
        goatStates.put(AnimalState.IS_PETTING, AnimationID.goat_is_petting);
    }
    ...
    static {
        ...
        sheepStates.put(AnimalState.IS_PETTING, AnimationID.sheep_is_petting);
    }
    ...
    static {
        ...
        pigStates.put(AnimalState.IS_PETTING, AnimationID.pig_is_petting);
    }
}
