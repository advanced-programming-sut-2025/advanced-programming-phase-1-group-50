    ...
    public void run() {
        ...
        while (running.get()) {
            try {
                ...
                if(message.getType().equals(MessageType.EVENT_IN_GAME) || message.getType().equals(MessageType.UPDATE_REACTION) || message.getType().equals(MessageType.UPDATE_HOT_BAR)) System.out.println(message); //TODO
