    ...
    public void run() {
        ...
        while (running.get()) {
            try {
                ...
                if(message.getType().equals(MessageType.UPDATE_HOT_BAR) || message.getType().equals(MessageType.UPDATE_GAME_RESULT) || message.getType().equals(MessageType.LOBBY_PLAYERS_LIST_UPDATED)) System.out.println(message); //TODO
